...
export default function EventCard({
  ...
  return (
    <div className="bg-white rounded-2xl shadow p-0 flex flex-col w-[290px] max-w-full border border-[#E5E5E5] cursor-pointer">
      ...
      <div className="p-4 pt-2 flex flex-col gap-2">
        <div className="flex items-center justify-between mb-1">
          <span className="font-semibold text-[16px] text-black truncate">{title}</span>
          <button className="rounded-full flex items-center justify-center w-screen h-screen max-w-[34px] max-h-[34px] cursor-pointer" title="Share">
            <Image src="/assets/icons/shareIcon.svg" alt="Share" width={34} height={34} />
          </button>
        </div>
        ...
        <hr className="my-2 border-t border-[var(--color-card-divider)]" />
        <div className="flex items-center justify-between">
          ...
          <button className="flex items-center gap-1 text-[15px] font-semibold [color:var(--color-text-detail)] cursor-pointer">
            Get Ticket
            <Image src="/assets/icons/arrowRightIcon.svg" alt="arrow" width={18} height={18} />
          </button>
        </div>
      </div>
    </div>
