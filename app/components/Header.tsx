        ...
        <div className='pt-5 px-5'>
            <div className='pl-6 pr-4 py-4 w-full max-w-[1200px] m-auto dark:border dark:border-[#282828] bg-white dark:bg-[#0D0D0D] rounded-[100px] flex items-center justify-between'>
                ...
                <div className='hidden lg:flex items-center gap-2'>
                    <button className='w-11 h-11 flex items-center justify-center text-[#2C0A4A] dark:text-[#D7B5F5] border-2 border-[#2C0A4A] dark:border-[#D7B5F5] rounded-full'><Search /></button>
                    <button className='cursor-pointer px-6 py-3 border-2 border-[#751AC6] text-[#751AC6] rounded-full font-bold transition-all duration-300 dark:hover:border-gray-50 dark:hover:text-gray-50'>Connect Wallet</button>
                    <button className='cursor-pointer px-6 py-3 border bg-[#751AC6] text-white dark:text-[#0D0D0D] rounded-full font-bold transition-all duration-300 dark:hover:drop-shadow-[0_0_2em_rgba(255,255,255,0.3)] dark:hover:text-gray-50'>Host Event</button>
                </div>
                <button onClick={() => setIsOpen(!isOpen)} className='lg:hidden border-2 border-[#751AC6] rounded-lg p-3'>
                    <BarsIcon />
                </button>
                {isOpen && (
